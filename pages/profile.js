        ...
        <div class="container mx-auto">
          <div class="flex flex-wrap py-8 flex-col sm:flex-row">
            ...
            <div class="sm:pl-10 sm:pt-4 flex-1">
              ...
              <p class="text-gray-500 leading-normal px-4 sm:px-0">I make things.</p>
            </div>
          </div>
        </div>
        ...
        <div class="container mx-auto">
          <div class="flex flex-wrap md:-mx-3">
            <div class="md:w-1/2 px-3 mb-6 w-full">
              <div
                class="flex ring-2 ring-opacity-50 ring-gray-100 w-full h-full flex-col flex-wrap p-5 rounded overflow-hidden transform motion-safe:hover:scale-110 decoration-clone"
                style={{ backgroundColor: '#1a1a1a' }}
              >
                <a href="#">
                  <h2 class="text-white text-lg mb-2">oasis</h2>
                </a>
              ...
              >
                <a href="#">
                  <h2 class="text-white text-lg mb-2">
                    <strong>carbon-app</strong>/carbon
                  </h2>
                </a>
            ...
            <div class="md:w-1/2 px-3 mb-6 w-full">
              ...
              >
                <a href="">
                  <h2 class="text-white text-lg mb-2">lunar-theme</h2>
                </a>
                <p class="text-white opacity-75 overflow-clip">
                  A minimal dark and light theme for Visual Studio Code.
                </p>
                <div class="flex flex-wrap justify-between items-center mt-auto pt-6">
                  <div class="inline-flex items-center">
                    <div class="relative inline-flex rounded-full h-3 w-3 bg-blue-700"></div>
            ...
            <div class="md:w-1/2 px-3 mb-6 w-full">
              ...
              >
                ...
                <p class="text-white opacity-75 overflow-clip">
                  Discover a wide collection of tools made by the community - for you. Search,
                  filter, and find new tools.
                </p>
                <div class="flex flex-wrap justify-between items-center mt-auto pt-6">
                  <div class="inline-flex items-center">
                    <div class="relative inline-flex rounded-full h-3 w-3 bg-yellow-500"></div>
            ...
            <div class="md:w-1/2 px-3 mb-6 w-full">
              ...
              >
                ...
                <p class="text-white opacity-75 overflow-clip">
                  Emoji shortcode's for Github commit messages for anything markdown-related! Copy
                  emojis/codes and use them for the right purposes.
                </p>
                <div class="flex flex-wrap justify-between items-center mt-auto pt-6">
                  <div class="inline-flex items-center">
                    <div class="relative inline-flex rounded-full h-3 w-3 bg-yellow-500"></div>
