...
export const Post: React.FC<PostProps> = (props: PostProps) => {
  return (
    <div className="shadow-lg max-w-[550px] w-full min-h-[220px] bg-gray-800 p-4 rounded-2xl flex flex-col justify-between">
      <div>
        <header className="flex items-center space-x-4">
          ...
          <div className="flex items-center justify-between w-full">
            <div>
              ...
              <p className="-mt-1 text-gray-200 font-bold">@{props.username}</p>
            </div>
