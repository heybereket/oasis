      ...
      <div className="max-w-5xl mx-auto px-8">
        ...
        <div className="relative z-10 mt-24">
          ...
          <p className="text-gray-300 text-base sm:text-xs md:small mt-3">
            ...
            <Link href="/privacy">
               <a className="text-primary-light hover:underline">Privacy Policy</a></Link>
             and <Link href="/terms"><a className="text-primary-light hover:underline">Terms of Service</a></Link> </p>
        </div>
      </div>
