...
export const ProfilePost: React.FC<ProfilePostProps> = ({avatar_url, name, atTag, quotes, likes, replies, message}:ProfilePostProps) => {
  return (
    <div className="mb-8"> 
        <div className="flex items-center mb-4">
            <img className="w-12 h-12 rounded-full mr-4" src={avatar_url} alt={name}/>
            <div>
